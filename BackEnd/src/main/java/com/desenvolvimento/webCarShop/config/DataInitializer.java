...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        if (userRepository.count() == 0) {
            User admin = new User("Ariane Paim", "ariane@gmail.com", "123456", UserRoles.ADMIN);
            User user = new User("Ravi Ribeiro", "ravi@gmail.com", "12345", UserRoles.USER);
        ...
        if (vehicleRepository.count() == 0) {
            ...
            Vehicle vehicle3 = new Vehicle(null, "Corolla", "Toyota", "Sedan", 80000.0, 2021, "Prata", "https://cdn.motor1.com/images/mgl/O64MB/s1/toyota-corolla-gr-s-2022-em-destaque.jpg");
            Vehicle vehicle4 = new Vehicle(null, "Yaris", "Toyota", "Hatch", 85000.0, 2020, "Prata", "https://www.notion.so/image/https%3A%2F%2F..."); // Coloque o URL correto da imagem
            Vehicle vehicle5 = new Vehicle(null, "Civic", "Honda", "Sedan", 90000.0, 2021, "Prata", "https://s2-autoesporte.glbimg.com/8AsyIQCc2_sNbOsJXNUPQI87qYw=/0x0:1920x1080/924x0/smart/filters:strip_icc()/i.s3.glbimg.com/v1/AUTH_cf9d035bf26b4646b105bd958f32089d/internal_photos/bs/2022/U/M/0AQABNTsW6kmItO0mGaQ/sem-titulo.jpg");
            Vehicle vehicle6 = new Vehicle(null, "Hilux", "Toyota", "Camioneta", 150000.0, 2022, "Prata", "https://s2-autoesporte.glbimg.com/OxyaYHlhU189ePBSMzKJiXgZVmQ=/1200x/smart/filters:cover():strip_icc()/i.s3.glbimg.com/v1/AUTH_cf9d035bf26b4646b105bd958f32089d/internal_photos/bs/2020/r/t/ep2d8wRECqx7357S2TcQ/2020-06-04-toyota-hilux-2021-1600-01.jpg");
            ...
            Vehicle vehicle8 = new Vehicle(null, "RAV4", "Toyota", "Sedan", 350000.0, 2023, "Prata", "https://media.toyota.com.ar/24270e31-3608-4461-907d-e805e2d46caa.png");
